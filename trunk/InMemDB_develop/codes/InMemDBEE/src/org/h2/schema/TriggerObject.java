...
public class TriggerObject extends SchemaObjectBase {
    ...
    // trigger: support queue and noWait = false as well
    private int queueSize = DEFAULT_QUEUE_SIZE;
    private boolean noWait;
    private Table table;
    private String triggerClassName;
    private InMemDBTrigger triggerCallback;
    ...
    private synchronized void load(Session session) {
        ...
        try {
            ...
            triggerCallback = (InMemDBTrigger) obj;
    ...
    public void fire(Session session, int type, boolean beforeAction) {
        ...
        try {
            ...
            triggerCallback.fireTrigger(session, null, null);
        } catch (Throwable e) {
    ...
    public boolean fireRow(Session session, Row oldRow, Row newRow, boolean beforeAction, boolean rollback) {
        ...
        try {
            ...
            //added by qil.wong, fire another api with session argument
            triggerCallback.fireTrigger(session, oldList, newList);
