...
public class SQLServerPagingPlugin extends PluginAdapter {
	...
	public boolean sqlMapDocumentGenerated(Document document,
		...
		inner_where_sql.addAttribute(new Attribute("id",
				"select_by_page_inner_where_and_orderby_sql"));
		sb.setLength(0);
		sb.append("  <if test=\"oredCriteria.size>0\">");
		sb.append("     <if test=\"_parameter != null\" > <include refid=\"Example_Where_Clause\"/> </if>");
		sb.append("  </if>");
		...
		outter_orderby_sql.addAttribute(new Attribute("id",
				"select_by_page_outter_orderby_sql"));
		sb.setLength(0);
		sb.append("   <if test=\"orderByClause != null\">");
		sb.append("    order by ${orderByClause} ");
		sb.append("  </if> ");
		...
		if (pks.size() == 1) {
			sb.append(MyBatis3FormattingUtilities
					.getAliasedEscapedColumnName(pks.get(0)));
		} else {
