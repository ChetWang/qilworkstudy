...
public class UMS3_MsgSendStub extends org.apache.axis2.client.Stub {
	...
	public void sendWithoutAck(
			com.nci.ums.client.ws.UMS3_MsgSendStub.SendWithoutAck sendWithoutAck
	...
	com.nci.ums.client.ws.UMS3_MsgSendStub.SendWithAck sendWithAck)
			...
			if (serializeType) {
				...
				if ((namespacePrefix != null)
					...
					writeAttribute("xsi",
							...
							"type", namespacePrefix + ":sendWithoutAck",
							xmlWriter);
				} else {
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", "sendWithoutAck", xmlWriter);
				}
		...
		public void serialize(
			...
			if (serializeType) {
				...
				if ((namespacePrefix != null)
					...
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", namespacePrefix + ":sendWithAck", xmlWriter);
				} else {
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", "sendWithAck", xmlWriter);
				}
		...
		public void serialize(
			...
			if (serializeType) {
				...
				if ((namespacePrefix != null)
					...
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", namespacePrefix + ":sendWithAckResponse",
							xmlWriter);
				} else {
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", "sendWithAckResponse", xmlWriter);
				}
