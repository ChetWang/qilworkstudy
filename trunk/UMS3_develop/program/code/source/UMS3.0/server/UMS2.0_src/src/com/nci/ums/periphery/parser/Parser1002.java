...
protected void initRules() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      sb.append(Util.getFixedString("01002",14)).append(Util.getFixedString("001",35)).append(Util.getFixedString("1",3)).append(Util.getFixedString("13575471065",255)).append(Util.getFixedString("#a请回复",160)).append("1").append(Util.getFixedString("",30)).append(Util.getFixedString("",2)).append(Util.getFixedString("",2));
