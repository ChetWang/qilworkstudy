...
/*    */ 
/*    */   public SGIPDeliverRepMessage(int result)
/*    */     throws IllegalArgumentException
/*    */   {
/* 27 */     if ((result < 0) || (result > 255)) {
/* 28 */       throw new IllegalArgumentException(String.valueOf(String.valueOf(new StringBuffer(String.valueOf(String.valueOf(SGIPConstant.DELIVER_REPINPUT_ERROR))).append(":result").append(SGIPConstant.INT_SCOPE_ERROR))));
/*    */     }
/*    */ 
/* 32 */     int len = 29;
/*    */ 
...
/* 38 */     TypeConvert.int2byte(-2147483644, this.buf, 4);
/*    */ 
...
/*    */   {
/* 54 */     String tmpStr = "SGIP_DELIVER_REP: ";
...
/*    */   {
/* 64 */     return -2147483644;
/*    */   }
/*    */ }

/* Location:           D:\Documents\work\UMS3_develop\program\code\source\UMS3.0\server\lib\smproxy.jar
 * Qualified Name:     com.huawei.insa2.comm.sgip.message.SGIPDeliverRepMessage
