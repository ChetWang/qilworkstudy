...
prompt Disabling triggers for SYSTEM_SERVER...
alter table SYSTEM_SERVER disable all triggers;
prompt Deleting SYSTEM_SERVER...
delete from SYSTEM_SERVER;
commit;
prompt Loading SYSTEM_SERVER...
insert into SYSTEM_SERVER (SYSTEMNAME, OWNERNAME, SERVERIP, SERVERPORT, CONSOLEIP)
values ('wangqlSystem', 'qlwang', '192.168.133.125', 10000, '192.168.133.125');
commit;
prompt 1 records loaded
prompt Enabling triggers for SYSTEM_SERVER...
alter table SYSTEM_SERVER enable all triggers;
