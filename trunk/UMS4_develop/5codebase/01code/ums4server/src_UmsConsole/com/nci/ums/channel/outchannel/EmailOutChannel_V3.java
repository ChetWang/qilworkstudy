 ...
 * @author Qil.Wong
 */
public class EmailOutChannel_V3 extends OutChannel {
...
//						.getContent());
				messageBodyPart.setContent("<meta   http-equiv=Content-Type   content=text/html;   charset=UTF-8>"+msgs[i].getBasicMsg().getMsgContent()
