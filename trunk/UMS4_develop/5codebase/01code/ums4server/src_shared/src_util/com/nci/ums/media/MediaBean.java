...
public class MediaBean implements Serializable {
	...
	public MediaBean(String mediaID, String mediaName, int mediaType,
			int mediaStatus) {
	...
	public boolean equals(Object anObject) {
		...
		if (anObject instanceof MediaBean) {
			MediaBean o = (MediaBean) anObject;
			flag =  o.getMediaID().equals(mediaID)
					&& o.getMediaName().equals(mediaName)
					&& o.getMediaStatus() == mediaStatus
					&& o.getMediaType() == mediaType;
		}
		return flag;
	}
