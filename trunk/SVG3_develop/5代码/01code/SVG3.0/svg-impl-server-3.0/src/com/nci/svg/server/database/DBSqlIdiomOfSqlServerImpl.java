 ...
 *
 */
public class DBSqlIdiomOfSqlServerImpl extends DBSqlIdiomAdapter {
	...
	public String getPartResultSet(String sql, int min, int max) {
		...
		.append(sql).append(") svg_t WHERE ROWNUM <= ")
		.append(max).append(") WHERE NCI_R > ").append(min);
