...
public class ColorChooser extends JColorChooser{
     ...
     */
    public ColorChooser(EditorAdapter editor){
        ...
        try{
            ...
            w3cSVGColorFlavor=new DataFlavor(
            		DataFlavor.javaJVMLocalObjectMimeType+";class=fr.itris.glips.svgeditor.colorchooser.SVGW3CColor");
