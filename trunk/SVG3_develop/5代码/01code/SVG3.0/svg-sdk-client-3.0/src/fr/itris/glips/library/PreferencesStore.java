...
public class PreferencesStore {
	...
	static {
		...
		try {
			preferences = Preferences
					.userNodeForPackage(SysSetDefines.class);
		} catch (Exception ex) {
		}
	}
	 ...
	 * 
	 * @param nodeId
	 *            the id of the node on which the preference should be retrieved
	 ...
	 * 
	 * @param nodeId
	 *            the id of the node on which the preference should be set (if
	 *            null or empty the default node will be taken)
	 * @param id
	 *            the id of a preference
	 * @param value
	 *            the new value of a preference
	 */
