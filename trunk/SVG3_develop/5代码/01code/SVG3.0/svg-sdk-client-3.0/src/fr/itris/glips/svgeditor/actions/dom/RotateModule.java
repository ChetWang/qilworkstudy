...
public class RotateModule extends DomActionsModule {
	 ...
	 *            the editor
	 */
	public RotateModule(EditorAdapter editor) {
	...
	protected void doAction(SVGHandle handle, Set<Element> elements, int index,
		...
		Map<Element, Point2D> centerPointsMap = new HashMap<Element, Point2D>();
		Map<Element, Double> anglesMap = new HashMap<Element, Double>();
