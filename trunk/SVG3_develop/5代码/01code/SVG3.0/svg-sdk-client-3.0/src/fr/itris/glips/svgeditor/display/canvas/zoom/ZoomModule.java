...
import fr.itris.glips.svgeditor.actions.dom.CanvasSizeDialog;
...
public class ZoomModule extends ModuleAdapter{
	 ...
	 */
	public ZoomModule(EditorAdapter editor) {
		super(editor);
	...
	public ActionListener getActionListner(){
		return listener;
	}
