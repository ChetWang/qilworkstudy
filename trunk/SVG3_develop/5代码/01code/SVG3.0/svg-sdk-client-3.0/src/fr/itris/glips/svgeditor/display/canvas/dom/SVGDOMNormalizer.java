...
import fr.itris.glips.library.geom.PolyShape2D;
...
public class SVGDOMNormalizer {
     ...
     * string constants
     */
    public static final String styleAttributeName = "style",  gTagName = "g",  textNodeName = "#text",  textTagName = "text",  tspanTagName = "tspan", /*viewBoxAtt="viewBox", */  defsTagName = "defs",  styleAtt = "style",  stopOpacityAtt = "stop-opacity",  stopColorAtt = "stop-color",  lineTagName = "line",  polygonTagName = "polygon",  polylineTagName = "polyline",  x1Att = "x1",  x2Att = "x2",  y1Att = "y1",  y2Att = "y2",  pointsAtt = "points",  pathTagName = "path",  dAtt = "d",  transformAtt = "transform",  circleTagName = "circle",  ellipseTagName = "ellipse",  rxAtt = "rx",  ryAtt = "ry",  rAtt = "r";
    /**
     * a svg handle
     */
...
//                computeDefs(doc); //deprecated by wangql, 没找到有何作用，并且在有些情况下，会陷入死循环
                ...
                for (NodeIterator nit = new NodeIterator(root); nit.hasNext();) {
                    ...
                    if (node != null && nsp.equals(node.getNamespaceURI()) &&
                        ...
                        handle.getEditor().getColorChooser().checkColorString(handle, el);
...
//                    	Utilities.printNode(aDefs, true);
//                    	Utilities.printNode(defs, true);
    ...
    protected void translateFromAttributesToStyle(Node node) {
        ...
        if (node != null && node instanceof Element &&
            ...
            HashSet<String> styleProperties =
            	handle.getEditor().getResourcesManager().getAttributesToTranslate();
