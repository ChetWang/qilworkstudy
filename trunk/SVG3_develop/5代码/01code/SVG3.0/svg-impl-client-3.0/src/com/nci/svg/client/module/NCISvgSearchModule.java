...
import com.nci.svg.client.ui.search.NCISvgSearchDialog;
...
public class NCISvgSearchModule extends ModuleAdapter {
	...
	public NCISvgSearchModule(EditorAdapter editor) {
		super(editor);
	...
	private void initModule() {
		...
		searchDialog = new NCISvgSearchDialog(editor.findParentFrame(), true,
				this);
	}
	 ...
	 */
	public void search() {
		searchDialog.setLocationRelativeTo(editor.findParentFrame());
