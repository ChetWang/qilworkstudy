...
import com.nci.svg.module.NCISvgSearchModule;
import com.nci.svg.search.NCISvgSearchManager;
import com.nci.svg.search.SearchItem;
...
public class NCISvgSearchDialog extends javax.swing.JDialog {
    ...
    public void initSearchItems() {
        ...
        for (int i = 0; i < items.getLength(); i++) {
            ...
            // 默认只搜索文本
            if (code.equalsIgnoreCase("com.nci.svg.search.TextSearchItem")) {
