...
public class DropDownButton extends Box {
	...
	public DropDownButton(JButton mainButton) {
		...
		dropDownButton.addMouseListener(dropDownListener);
		...
		dropDownButton.setFocusPainted(false);
                mainButton.addMouseListener(dropDownListener);
		add(dropDownButton);
	 ...
	 * 
	 * @param enable
	 *            if true, a click on the main button will trigger an
	...
	/**
	 * This object watches for insertion/deletion of menu items in the popup
	 * menu, and disables the drop-down button when the popup menu becomes
	 * empty.
	 */
