...
public class DOMViewerModule extends ModuleAdapter{
	 ...
	 * the dom viewer
	 */
	private SVGDOMViewer domViewerDialog=new SVGDOMViewer();
     ...
     */
    public DOMViewerModule(final Editor editor) {
    	super(editor);
				...
				public void valueChanged(TreeSelectionEvent ev) {
					...
					if(currentHandle!=null){
						...
						DefaultMutableTreeNode mtn=
							(DefaultMutableTreeNode)panel.getTree().getLastSelectedPathComponent();
