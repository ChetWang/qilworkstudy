...
public class SVGVisualResourceShapeIdChooser {
     ...
     * the labels
     */
    private static String titleLabel="", titledBorderLabel="", okLabel="", cancelLabel="", alertMessage="", errorTitle="";
     ...
     */
    public static String showShapeChooserIdDialog(final SVGHandle handle){
        ...
        if(handle!=null){
            ...
            //creating the dialog
        	Container parentContainer=handle.getEditor().getParent();
            ...
            LinkedList nodesIds=
            	handle.getSvgElementsManager().getShapeNodesIds();
                ...
                public void actionPerformed(ActionEvent evt) {
                    ...
                    if(evt.getSource().equals(okBt)){
                        ...
                        if(selectedId==null || (selectedId!=null && selectedId.equals(""))){
                            ...
                            JOptionPane.showMessageDialog(handle.getEditor().getParent(), falertMessage, ferrorTitle, JOptionPane.ERROR_MESSAGE);
                            return;
                        }
