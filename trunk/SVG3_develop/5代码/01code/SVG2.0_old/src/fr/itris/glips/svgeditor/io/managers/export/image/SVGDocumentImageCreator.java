...
public class SVGDocumentImageCreator {
	 ...
	 *            the monitor
	 */
	public SVGDocumentImageCreator(Document doc, Monitor monitor,Editor editor) {
...
//		} else {
			try {
				...
				// 背景色的处理
				if ((Boolean)editor.getGConfig().getParam(NCIGlobal.EXPORT_INCLUDE_BACKGROUND_Str)) {
