...
public abstract class SelectionChangedListener {
	...
	/**
	 * notifies the object registering this listener that the selection has changed on 
	 * the svg canvas associated to the selection manager
	 * @param selectedElements the setof the selected elements
	 */
