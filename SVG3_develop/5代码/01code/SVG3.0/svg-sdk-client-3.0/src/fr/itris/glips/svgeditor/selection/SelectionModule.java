...
public class SelectionModule extends ModuleAdapter {
     ...
     */
    public SelectionModule(EditorAdapter editor) {
    	super(editor);
    ...
    protected void createMenuAndToolItems() {
        ...
        ActionListener selectionListener = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                if (evt.getModifiers() == InputEvent.BUTTON1_DOWN_MASK ||
                    ...
                    editor.getSelectionManager().setSelectionMode(mode, null);
                    //added by wangql
        ...
        editor.getSelectionManager().setRegularButton(regularSelectionToolItem);
    ...
    protected void updateMenuItems() {
        ...
        if (handle != null) {
            ...
            if (parentElement != null && !parentElement.equals(
                    ...
                    && !isGraphUnitElement(parentElement)) {
...
//        toolItems.put(zoneSelectionId, zoneSelectionToolItem);
    ...
    public Collection<PopupItem> getPopupItems() {
        ...
        PopupItem groupEnterItem = new PopupItem(
        		editor, enterGroupId, enterGroupLabel, enterGroupId) {
        ...
        PopupItem groupExitItem = new PopupItem(
        		editor, exitGroupId, exitGroupLabel, exitGroupId) {
        ...
        PopupItem lockItem = new PopupItem(
        		editor, lockId, lockLabel, lockId) {
        ...
        PopupItem unLockItem = new PopupItem(
        		editor, unLockId, unLockLabel, unLockId) {
    ...
    private boolean isGraphUnitElement(Element element)
    {
    	if(element.getNodeName().equals("g") && element.getAttribute("symbol_type") != null 
    			&& element.getAttribute("symbol_type").equals("graphunit"))
    		return true;
    	return false;
    }
}
