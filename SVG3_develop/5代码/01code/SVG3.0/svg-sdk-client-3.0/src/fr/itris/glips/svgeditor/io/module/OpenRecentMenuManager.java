...
public class OpenRecentMenuManager {
	 ...
	 */
	public OpenRecentMenuManager(EditorAdapter editor){
		this.editor = editor;
	...
	protected void updateMenuItems() {
		...
		LinkedList<String> recentFilesList=
			editor.getResourcesManager().getRecentFiles();
	...
	private EditorAdapter getEditor(){
		return editor;
	}
