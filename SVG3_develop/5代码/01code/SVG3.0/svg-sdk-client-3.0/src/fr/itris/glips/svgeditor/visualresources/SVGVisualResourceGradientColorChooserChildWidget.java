...
public class SVGVisualResourceGradientColorChooserChildWidget extends SVGVisualResourceChildWidget{
    ...
    protected void buildComponent(){
        ...
        if(resourceObject!=null && resourceObject.getChildren().getFirst()!=null){
            ...
            final EditorAdapter svgEditor=resourceObject.getResourceModel().getVisualResources().getEditor();
                ...
                public void mouseReleased(MouseEvent e) {
                    ...
                    if(currentItem!=null){
                        ...
                        if(e.getClickCount()==2){
                        	...
                        	Color color=resourceObject.getResourceModel().getVisualResources().getEditor().getColorChooser().showColorChooserDialog(colorPanel.getBackground());
                            
                            if(color!=null && currentItem!=null){
                                
                                colorPanel.setBackground(color);
                                currentItem.setColor(color);
                                resourceObject.getResourceModel().getVisualResources().getEditor().getSVGColorManager().setCurrentColor(color);
    ...
    protected class SVGGradientChooserItem{
        ...
        protected Color computeColor(){
            ...
            if(styleResAttribute!=null){
                ...
                if(ind!=-1){
                    ...
                    EditorAdapter editor=resChild.getChildModel().getVisualResources().getEditor();
        ...
        protected double computeOpacity(){
            ...
            if(styleResAttribute!=null){
                ...
                if(ind!=-1){
                    ...
                    op=resChild.getChildModel().getVisualResources().getEditor().getSVGToolkit().getDoubleValue(val, true)/100;
                }
            }
        ...
        protected void applyColor(){
            ...
            if(color!=null && styleResAttribute!=null){
                ...
                val=val.concat(prop.concat(":".concat(resourceObject.getResourceModel().getVisualResources().getEditor().getColorChooser().getColorString(color)).concat(";")));
