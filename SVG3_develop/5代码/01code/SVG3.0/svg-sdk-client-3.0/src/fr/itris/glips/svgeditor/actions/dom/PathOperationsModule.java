...
public class PathOperationsModule extends DomActionsModule {
	 ...
	 */
	public PathOperationsModule(EditorAdapter editor) {
     ...
     * @param parentElement the parent element
     * @param pathManager the path manager
     * @param fillColorString 填充色
     * @param strokeColorString 边界色
     * @return  the created path element
     */
    protected Element createElement(
            Element parentElement, Path pathManager,
            String fillColorString,String strokeColorString){
        ...
        //setting the element style
        element.setAttributeNS(
                null, "style", "fill:"+fillColorString+";stroke:" + strokeColorString + ";");
