...
public class FileChooserDialog extends TitledDialog {
	 ...
	 *            the mode of the file chooser
	 */
	public FileChooserDialog(Frame parent, int mode, EditorAdapter editor) {
	 ...
	 *            the mode of the file chooser
	 */
	public FileChooserDialog(JDialog parent, int mode, EditorAdapter editor) {
	...
	protected void initialize() {
		// System.out.println("BuildPaneWorker:"+getBuildPanelWorker().isFinished
		// ());
		// setting the properties to the file chooser
		if (editor.getModeManager().isJFileChooserCreate()) {
	...
	protected JPanel buildContentPanel() {
		...
		fileChooser = new SolidFileChooser(this);
			...
			public void caretUpdate(CaretEvent e) {
				...
				if (content != null && !content.equals("")) {
					...
					if (mode == OPEN_FILE_MODE) {
						...
						checkFilesConsistency(getFiles(fileChooser
								.getCurrentDirectory(), content));
		...
		ActionListener okListener = new ActionListener() {
			...
			public void actionPerformed(ActionEvent evt) {
				...
				editor.getResourcesManager().setCurrentDirectory(
	...
	public void showDialog(final JComponent relativeComponent) {
		...
		fileChooser.setCurrentDirectory(editor.getResourcesManager()
				.getCurrentDirectory());
		String java_version = System.getProperty("java.version");
//		if (java_version.indexOf("1.5") == 0)
			fileChooser.rescanCurrentDirectory();

		okButton.requestFocusInWindow();
		// FileChooserDialog.super.showDialog(relativeComponent);
	...
	/**
	 * 增加双击选择，自定义一个JFileChooser
	 * 
	 * @author Qil.Wong
	 * 
	 */
	private class SolidFileChooser extends JFileChooser {

		FileChooserDialog chooserParent;

		public SolidFileChooser(FileChooserDialog parent) {
