...
public class GridParametersDialog extends TitledDialog{
	...
	public GridParametersDialog(
		GridParametersManager gridParametersHandler, Frame parent,EditorAdapter editor) {
	 ...
	 */
	public GridParametersDialog(
		GridParametersManager gridParametersHandler, JDialog parent, EditorAdapter editor) {
	...
	protected JPanel buildContentPanel() {
		...
		colorChooserWidget=new ColorChooserWidget(editor);
