...
public class JPGExportDialog extends ExportDialog{
	...
	private JPanel sizechooser;

	/**
	 * the constructor of the class
	 * @param parent the parent frame
	 */
	public JPGExportDialog(Frame parent,EditorAdapter editor) {
	 ...
	 */
	public JPGExportDialog(JDialog parent,EditorAdapter editor) {
	...
	protected void initialize() {
		...
		sizechooser=getSizeChooserPanel();
