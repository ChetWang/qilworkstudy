...
public class MemoryMonitorModule extends ModuleAdapter{
     ...
     */
    public MemoryMonitorModule(EditorAdapter editor) {
    	super(editor);
			...
			new ActionListener(){
				...
				public void actionPerformed(ActionEvent arg0) {
					...
					if(! memoryMonitorDialog.isVisible()){
						...
						int 	x=(int)(getEditor().getParent().getLocationOnScreen().getX()+getEditor().getParent().getWidth()/2-memoryMonitorDialog.getSize().getWidth()/2), 
								y=(int)(getEditor().getParent().getLocationOnScreen().getY()+getEditor().getParent().getHeight()/2-memoryMonitorDialog.getSize().getHeight()/2);
