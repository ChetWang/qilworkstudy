...
public class NewDialog extends TitledDialog{
	 ...
	 */
	public NewDialog(FileNew fileCreationManager, Frame parent, EditorAdapter editor){
	 ...
	 * @param parent the parent of the dialog
	 */
	public NewDialog(FileNew fileCreationManager, JDialog parent, EditorAdapter editor){
			...
			public void actionPerformed(ActionEvent evt) {
				...
				if(evt.getSource().equals(okButton)){
					...
					fileCreationManager.createNewDocument(
						widthSpinner.getWidgetValue()+"", heightSpinner.getWidgetValue()+"",null);
				}
