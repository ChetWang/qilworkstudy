...
/**
 * the class that handles quadTo instructions
 * @author ITRIS, Jordi SUC
 */
public class QuadraticToSegment extends Segment{
	 ...
	 */
	public QuadraticToSegment(Segment previousSegment, double[] values){
	 ...
	 */
	public QuadraticToSegment(Segment previousSegment, String segmentString){
	...
	public void initialize() {
		...
		this.absoluteCmdName="Q";
		this.relativeCmdName="q";
	}
