...
public class UndoRedo extends ModuleAdapter{
	 ...
	 */
	public UndoRedo(SVGHandle svgHandle, EditorAdapter editor){
		super(editor);
	...
	public void addActionList(final UndoRedoActionList actionList, 
		...
		editor.getHandlesManager().handleContentChanged();
	}
	...
	public LinkedList<UndoRedoActionList> getUndoStack() {
		return undoStack;
	}

	public LinkedList<UndoRedoActionList> getRedoStack() {
		return redoStack;
	}
