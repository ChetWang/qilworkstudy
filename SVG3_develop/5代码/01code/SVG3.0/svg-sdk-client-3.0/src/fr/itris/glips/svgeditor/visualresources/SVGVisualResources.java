...
public class SVGVisualResources extends ModuleAdapter{
     ...
     */
    protected String undoredoresources="", undoredoresourcesnew="", undoredoresourcesremove="";
     ...
     */
    public SVGVisualResources(EditorAdapter editor){
        ...
        final HandlesListener svgHandlesListener=new HandlesListener(){
        	...
        	public void handleChanged(SVGHandle currentHandle, Set<SVGHandle> handles) {
                ...
                final SVGHandle handle=getEditor().getHandlesManager().getCurrentHandle();
                ...
                //if a new svg document has been created, the defs element is added, 
		...
		Runnable visibilityRunnable=new Runnable(){
			...
			public void run() {
				...
				SVGHandle svgHandle=getEditor().getHandlesManager().getCurrentHandle();
