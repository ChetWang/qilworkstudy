...
public class LayerSelectionPanel extends EditorPanel {
	...
	public LayerSelectionPanel(EditorAdapter editor, String layerType,
	...
	public ArrayList<String> getSelectLayers() {
		...
		for (int i = 0; i < tableModel.getRowCount(); i++) {
			if ((Boolean) tableModel.getValueAt(i, 1)) {
				...
				//TODO 层过滤需要重新完善
				editor.getLogger().log(null, LoggerAdapter.ERROR, "层过滤需要重新完善");
...
//			}
	...
	private void addOneRow(String value) {
		...
		//TODO 层过滤需要重新完善
		editor.getLogger().log(null, LoggerAdapter.ERROR, "层过滤需要重新完善");
//		obj = EquipPool.getComboMap().get(layerType).get(value);
