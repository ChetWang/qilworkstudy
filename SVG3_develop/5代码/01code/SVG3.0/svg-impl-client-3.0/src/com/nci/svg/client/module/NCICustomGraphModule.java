...
import static com.nci.svg.sdk.client.util.Constants.EDITOR_SPLIT_DIVIDERSIZE_NORMAL;
 ...
 * @author Qil.Wong
 */
public class NCICustomGraphModule extends
		ModuleAdapter {
	 ...
	 *            编辑器Editor对象
	 */
	public NCICustomGraphModule(EditorAdapter editor) {
		super(editor);
	...
	public void showPlatte() {
		...
		editor.getSplitPane().setDividerSize(EDITOR_SPLIT_DIVIDERSIZE_NORMAL);
		customUnitButton.setToolTipText(ResourcesManager.bundle
				.getString("nci_cusomunit_tooltip_hide"));
	}
