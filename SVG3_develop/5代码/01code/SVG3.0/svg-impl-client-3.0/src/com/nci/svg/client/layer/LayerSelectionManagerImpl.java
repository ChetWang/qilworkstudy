package com.nci.svg.client.layer;
...
public class LayerSelectionManagerImpl extends LayerSelectionManager{
	...
	public LayerSelectionManagerImpl(EditorAdapter editor) {
		super(editor);
	}
