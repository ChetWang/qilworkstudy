...
public class WaitDialog extends JDialog {
	...
	protected void build() {
		...
		errorTextArea = new JEditorPane("text/html",
	 ...
	 */
	public void setProgressMessage(String progressMessage, int value, int min,
			int max) {
		try {
	...
	public synchronized void setProgressMessageInAwtThread(
			final String progressMessage, final int value, final int min,
			final int max) {
	 ...
	 * @param isInError
	 *            whether the task of the monitor has failed
	 */
