...
public class TextShape extends AbstractShape {
	...
	public TextShape(Editor editor) {
		...
		if (editor.getParent() instanceof JDialog) {
			...
			textDialog = new TextDialog(this, (JDialog) editor.getParent(),editor);

		} else if (editor.getParent() instanceof Frame) {

			textDialog = new TextDialog(this, (Frame) editor.getParent(),editor);
		}
	}
...
//				+ ";stroke:none;");
		element.setAttributeNS(null, "style", "font-size:12pt;fill:"
				+ colorString + ";");
...
//				Element tspan = doc.createElement(SVGDOMNormalizer.tspanTagName);
...
//		Area a = new Area(handle.getSvgElementsManager().getNodeBounds(element));
//		areas.add(a);
