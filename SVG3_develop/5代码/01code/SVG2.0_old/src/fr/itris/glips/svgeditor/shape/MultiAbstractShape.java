...
public abstract class MultiAbstractShape extends AbstractShape {
	...
	public UndoRedoAction validateTranslateAction(SVGHandle handle, Set<Element> elementSet, 
		...
		UndoRedoAction urAction = translate(handle, elementSet, translationFactors);
	...
	protected UndoRedoAction getUndoRedoAction(
	   ...
	   protected UndoRedoAction getUndoRedoAction(final SVGHandle handle,
	            final UndoRedoAction undoRedoAction, 
	               final Set<Element> elementsSet){
	        ...
	        Runnable executeRunnable=new Runnable(){
	            ...
	            public void run() {
	                ...
	                rela.upholdElements(handle, elementsSet, UpholdElementRela.MODIFY_TYPE);
	            }
	        };
	        ...
	        //executing the action and creating the undo/redo action
	        return ShapeToolkit.getUndoRedoAction(
	                undoRedoAction.getName(), executeRunnable, undoRunnable, elementsSet);
	    }
	@Override
