 ...
 *
 * The class managing the resources,包括界面字符串、图形图标、xml配置等
 */
public class ResourcesManager {
   ...
   static{
     ...
     */
    private final java.util.List<String> recentFiles=
     ...
     */
    private Set<RecentFilesListener> recentFilesListeners=
    	Collections.synchronizedSet(new HashSet<RecentFilesListener>());
     ...
     */
    private final LinkedList<Runnable> exitRunnables=
    ...
    public ResourcesManager(Editor editor){
    	...
    	Preferences recentFilesPreferences=PreferencesStore.getPreferenceNode(
    			RECENT_FILES_PREFERENCE_ID);
        String[] keys=null;
    ...
    public Document getResourceStore(){
    	...
    	if(resourceStore!=null){
            ...
            SAXSVGDocumentFactory factory=
            	new SAXSVGDocumentFactory("org.apache.xerces.parsers.SAXParser");
    ...
    public void removeRecentFile(String fileName){
        ...
        if(recentFiles!=null && fileName!=null && 
        	! fileName.equals("") && recentFiles.contains(fileName)){
    ...
    public void notifyListeners(){
    	...
    	LinkedList<String> recentFilesList=
    		new LinkedList<String>(recentFiles);
    	
    	for(RecentFilesListener listener : 
    		new HashSet<RecentFilesListener>(recentFilesListeners)){
