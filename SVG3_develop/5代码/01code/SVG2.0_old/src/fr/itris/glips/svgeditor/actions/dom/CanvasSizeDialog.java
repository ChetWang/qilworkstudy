...
public class CanvasSizeDialog extends TitledDialog {
	 ...
	 */
	public CanvasSizeDialog(CanvasSizeModule svgCanvasModifier, Frame parent,Editor editor) {
	 ...
	 *            the parent of the dialog
	 */
	public CanvasSizeDialog(CanvasSizeModule svgCanvasModifier, JDialog parent,Editor editor) {
