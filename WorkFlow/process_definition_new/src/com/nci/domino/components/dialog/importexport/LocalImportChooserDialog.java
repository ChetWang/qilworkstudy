...
public class LocalImportChooserDialog extends WfSaveDialog {
	...
	String[] bannerSubTitles = new String[] { "将完整流程数据从特定格式的XML(.woml)文件中导入.",
			"将单个流程数据从特定格式的XML(.processml)文件中导入." };
	...
	public JComponent createBannerPanel() {
		WfBannerPanel headerPanel1 = new WfBannerPanel("打开或导入本地文件",
				"将流程数据从特定格式的XML(.woml)文件中导入.", Functions
