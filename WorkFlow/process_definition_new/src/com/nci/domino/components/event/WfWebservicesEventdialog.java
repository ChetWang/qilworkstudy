...
/**
 * <p>
 * 标题：WfWebservicesEventdialog.java
 * </p>
 * <p>
 * 描述： Webservices事件定义窗口
 * </p>
 * <p>
...
public class WfWebservicesEventdialog extends WfDialog {
	...
	public JComponent createBannerPanel() {
		WfBannerPanel headerPanel1 = new WfBannerPanel("WebServices事件定义",
				"用来定义WebServices事件", Functions
...
//			add(typeAddBtn, gridBagConstraints);
			...
			add(new JLabel("地址："), gridBagConstraints);
			...
			gridBagConstraints.weighty = 0;
			gridBagConstraints.gridheight = 1;
			add(new JLabel("登入名："), gridBagConstraints);
			...
			gridBagConstraints.weighty = 0;
			gridBagConstraints.gridheight = 1;
			add(new JLabel("登入密码："), gridBagConstraints);
			...
			gridBagConstraints.weighty = 0;
			gridBagConstraints.gridheight = 1;
			add(new JLabel("调用接口："), gridBagConstraints);
