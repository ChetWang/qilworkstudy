 ...
 *  1004交易的处理层
 */
public class Process1004 implements Processor {
    ...
    public String processOne(Map map, int count, String serial) throws ProcessException {
        ...
        try {
            ...
            MsgInfo msgInfo = CacheDataHelper.getMsg(appID, null);
            ...
            if (msgInfo != null) {
                ...
                if (msgInfo.getContentMode() != 4 && msgInfo.getContentMode() != 21) {
                    sb.append(Util.getFixedString(Util.convertFullToHalf(msgInfo.getContent()), 160));
                } else {
                    sb.append(Util.getFixedString(msgInfo.getContent(), 160));
                }
            ...
            e.printStackTrace();
            result = "1091";
            Res.log(Res.ERROR, "process1004 error:" + e);
