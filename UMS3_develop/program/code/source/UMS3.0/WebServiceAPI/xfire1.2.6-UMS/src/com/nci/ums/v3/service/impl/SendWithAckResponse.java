...
@XmlRootElement(name = "sendWithAckResponse")
public class SendWithAckResponse {

    @XmlElementRef(name = "return", namespace = "http://impl.service.v3.ums.nci.com", type = JAXBElement.class)
