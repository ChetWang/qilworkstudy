package timesten;
/*
 * $Id: Tptbm.java.proto /main/2 2009/12/01 09:53:11 dhood Exp $
...
class Tptbm
{
	...
	"create or replace procedure TPTBM_MULTI5_PROC ( " +
	"key_cnt IN number, " +
	"ins_id IN number, " +
	"ins_nb IN number, " +
	"multiop IN number " +
	...
	"begin " +
	"tptbm_multi5_proc(:kc, :id, :nb, :multiop); " +
	"end;";
